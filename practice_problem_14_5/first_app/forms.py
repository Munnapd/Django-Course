...
class contactForm(forms.Form):
      name = forms.CharField(max_length=100,label='User Name', help_text='Total Length Must Be With In 30 Characters', required=True, widget=forms.TextInput(attrs={'placeholder' : 'Enter Your Full Name'}))

      birthday = forms.DateField(widget=forms.DateInput(attrs={'type' : 'date'}))

      comment = forms.CharField(max_length=100,label='Comment', required=True, widget=forms.Textarea(attrs={'placeholder' : 'Enter Your Comment'}))
